...
namespace YuxiFlightInstruments
{
    ...
    public class YFI_SPDControl : UdonSharpBehaviour
    {
        ...
        [System.NonSerializedAttribute] public float SetSpeed = 0f;
        ...
        private void LateUpdate()
        {
            ...
            { 
                ...
                if (func_active)
                {
                    ...
                    error = (SetSpeed - (float)SAVControl.GetProgramVariable("AirSpeed"));
